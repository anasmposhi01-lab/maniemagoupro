...
static function prefix($url,$prefix){
   //var_dump('Urle est='.$url);var_dump('prefixe est='.$prefix);exit;
 self::$prefixes[$url] = $prefix;
}
/*
permet de passer l'url
ici en faisant $_server['path_info'], on obtient l'url suivant:/pages/view/index
@params=sera un tableau composé de nos paramètres:pages,view,index
*/
...
controller/action/(/:para/:param/:param....)
*/
