...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <!-- ------------------------------------------------------------------ -->
<?php foreach ($modifie_user as $k => $v): ?>
              <center><h4>Veuillez apporter vos modifications dans le formulaire ci-dessous 👇</h4></center> 
              <div class="reply-form">
                <form  method="post" action="<?php echo Router::url('users/modifie_user/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------->
                              <h3><a href="#" class="reply"></i> 👇 Veuiller Modifier le sexe de cet Utilisateur * </a></h3>
                              <select name="sexe" type="text" class="anas1">
                                       <option value="<?php echo $v->sexe; ?>"><strong><i>Sexe Actuel du User 👉 <?php echo $v->sexe; ?> *</i></strong></option>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!-------------------------------------------------->
                              <h3>✍ Veuiller Modifier la Fonction de cet Utilisateur</h3>
                              <input  class="form-control" type="text" name="role" value="<?php echo $v->role; ?>">
                           <!---------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <h3>✍ Veuiller Modifier le nom de l'Utilisateur</h3>
                              <input  class="form-control" type="text" name="nom" value="<?php echo $v->nom; ?>">
                              <!-------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <h3>✍ Veuiller Modifier le Post-nom de l'Utilisateur</h3>
                              <input  class="form-control" type="text" name="pst_noms" value="<?php echo $v->pst_noms; ?>">
                              <!---------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <h3>✍ Veuiller Modifier le Prénom de cet Utilisateur</h3>
                              <input  class="form-control" type="text" name="pr_noms" value="<?php echo $v->pr_noms; ?>">
                              <!--------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <input hidden  class="form-control" type="text" name="pass_propre" value="<?php echo $v->pass_propre; ?>">
                              <!---------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                           <!----------------------------------------------------------->
                              <input hidden  class="form-control" type="text" name="pass_hache" value="<?php echo $v->pass_hache; ?>">
                           <!---------------------------------------------------->
...
<!-- ------------------------------------------------------------------ -->
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('searchers/users/'); ?>" enctype="multipart/form-data" >
                  <div class="row">
                    <div class="col-md-6 form-group">
                              <select name="mode" type="text"  class="anas1">
                                       <option value="nom"><strong><i>Nom *</i></strong></option>
                                       <option value="post_noms"><strong><i>Post-nom *</i></strong></option>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item search-form">
                <form  method="post" action="<?php echo Router::url('searchers/users/'.$id=1); ?>" enctype="multipart/form-data" >
