<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href=""><?php  echo $total_Frequence;?> Frequences</a></li>
        </ol>
      </div>
            ...
            <article class="entry entry-single">
              <div class="blog-comments">
                <div id="comment-1" class="comment">
                  <center><h2>RAPPORT DE FREQUENTATION DU SITE</h2></center> 
                  <center><h2><><><><><><><><><><><><><><><><></h2></center>
                  <div class="d-flex">
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
                 <?php  foreach ($Frequence as $k=>$v): ?>
              <!-- ------------------------------------------------------------------ -->
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img">
                     <a href="<?php echo Router::webroot('courriers_entrants/'); ?>"> <img src="<?php echo Router::url('webroot/pdf.png'); ?>" class="testimonial-img"  alt=""> </a>
                  </div>
                  <div><h5><h5><a href=""><?php echo $v->nom.' - '.$v->pst_noms.' - '.$v->pr_noms.'; dont Foction:'.$v->role ; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> Action faite en date du: <?php  echo $v->date_connexion.' à :'.$v->heure_connexion; ?> </a></h5>
                    <time datetime="2020-01-01">👉 <b><?php echo  $v->commentaire_con_decon; ?></b> </time> 
                  </div>
                </div>
              </div>
              <div id="comment-1" class="comment">        
