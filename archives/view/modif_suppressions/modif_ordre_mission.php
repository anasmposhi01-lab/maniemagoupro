<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE D'ENREGISTREMENT DES ORDRES DE MISSION DU GOUVERNEMENT PROVINCIAL DU MANIEMA</h2>
        <u style="color: red;"><center>*******************************************************************</center></u>
        <ol>
          <li><a href="" style="color: red;"><?php echo $this->Session->flash(); ?></a></li>
          <li style="text-align: justify;">Cette page vous permet d'enrégistrer des Ordres de Mission.  Egalement, cette page permet de faire des recherches, en cas de besoin, dans notre serveur pour une utilisation utile. dans la partie annexe de cette page, vous êtes informé de toutes les statistiques liées au nombres de nos différents courriers, selon leur catégorie y compris les Arrêtés qui ont été signés par le Gouvernement Provincial du Maniema. Un bonus lié à l'accès aux listes reparties selon les différentes réunions tenues au Cabinet du Gouverneur s'y trouvent également.
          </li>
        </ol>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <!-- ------------------------------------------------------------------ -->
<?php  foreach ($modifie_ordre_mission as $k=>$v): ?>
              <div class="reply-form">
                <h4>Veuillez prendre soin de remplir ce formulaire</h4>
                <form  method="post" action="<?php echo Router::url('modif_suppressions/modif_ordre_mission/'); ?>" enctype="multipart/form-data">

                  <div>
                          <div  class="tiny-editable">
                              <input hidden type="number" name="id" value="<?php echo $v->id; ?>">
                              <input hidden type="number" name="file" value="<?php echo $v->file; ?>">
                          

                              <h3>✍ Modifier l'Objet de cet Ordre de Mission *</h3>
                              <textarea  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;" name="objet" type="text" class="form-control" value="<?php echo $v->objet; ?>"><?php echo $v->objet; ?></textarea>
                              <!---------------------------------------------->
                          </div>
                  </div>
                  ...
                  <div class="row">
                          <div class="col form-group">
                              <h3>✍ Modifier le Numéro de cet Ordre de Mission *</h3>
                              <input type="text" class="form-control" name="num" value="<?php echo $v->num;?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                          </div>
                  </div>
                  <div class="row">
                          <div class="col form-group">
                              <h3>✍ Modifier la Destination de cet Ordre de Mission *</h3>
                              <input type="text" class="form-control" name="destination" value="<?php echo $v->destination;?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                          </div>
                  </div>
                  <div class="row">
                          <div class="col form-group">
                              <h3>✍ Modifier le Nom du Titulaire de cet Ordre de Mission *</h3>
                              <input type="text" class="form-control" name="nom_titulaire_mission" value="<?php echo $v->nom_titulaire_mission;?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                          </div>
                  </div>
                  <div class="row">
                          <div class="col form-group">
                              <h3>✍ Modifier la Fonction du Titulaire de cet Ordre de Mission * </h3>
                              <input type="text" class="form-control" name="fonction_titulaire_mission" value="<?php echo $v->fonction_titulaire_mission;?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                          </div>
                  </div>
                  <div class="row">
                          <div class="col form-group">
                              <h3>✍ Modifier la date de signature de cet Ordre de Mission</h3>
                              <input type="text" class="form-control" name="date_signature" value="<?php echo $v->date_signature;?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                          </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                              <select name="mode" type="text"  class="anas1">
                                       ...
                                       <option value="destination"><strong><i>Destination *</i></strong></option>
