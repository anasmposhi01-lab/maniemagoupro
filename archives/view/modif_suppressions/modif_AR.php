...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <!-- ------------------------------------------------------------------ -->
<?php  foreach ($accus as $k=>$v): ?>
              <center><h4>Veuillez apporter vos modifications dans le formulaire ci-dessous 👇</h4></center> 
              <div class="reply-form">
                <form  method="post" action="<?php echo Router::url('modif_suppressions/modif_AR/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6 form-group">
                              ...
                              <select name="type" type="text" class="anas1">
                                       <option value="<?php  echo $v->type; ?>">
                                            <strong><i>
                                              (Valeur actuelle):👉<?php  echo $v->type; ?>
                                            </i></strong>
                                       </option>
                  ...
                  <div class="row">
                    <div class="col form-group">
                             <input hidden type="number" name="id" value="<?php echo $v->id; ?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Numéro de Courrier à modifier</h3>
...
<!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Le nom du Signataire de ce Courrier à modifier</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Le numéro de téléphone de la personne à qui le courrier a été adressé</h3>
...
<!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ L'Objet de ce Courrier à modifier</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ la date de reception de ce Courrier à modifier</h3>
                              <input  class="form-control" type="text" name="date_reception" value="<?php echo $v->date_reception; ?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ le nom de la personne à qui notre courrier s'adresse</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                              <input hidden  type="text" name="file" value="<?php echo $v->file; ?>">
                              <!----------------------------------------------------------------------------------------------------------------->
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item search-form">
                <form   method="post" action="<?php echo Router::url('searchers/accuse_reception/'.$id=1); ?>" enctype="multipart/form-data" >
                  <input type="text">
                  <button type="submit" placeholder="Entrez votre  Référence *"><i class="bi bi-search"></i></button>
                </form>
