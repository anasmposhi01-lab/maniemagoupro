...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <!-- ------------------------------------------------------------------ -->
<?php foreach ($modifie_entr as $k => $v): ?>
              <center><h4>Veuillez apporter vos modifications dans le formulaire ci-dessous 👇</h4></center> 
              <div class="reply-form">
                <form  method="post" action="<?php echo Router::url('modif_suppressions/modif_entrant/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!------------------------------------------------------------------------>
                              <h3>✍ Veuiller entrer le Numéro accordé par nos Service à ce Courrier</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <h3>✍ Veuiller entrer le nom de le nom de la Personne Signataire de ce Courrier</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!---------------------------------------------------------------->
                              <h3>✍ Veuiller entrer le Nom de l'Expéditeur Principalement oule nom de la Société: c'est facultatif *</h3>
                              <input  class="form-control" type="text" name="expediteur" value="<?php echo $v->expediteur; ?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer le Numéro de Téléphone du Propriétaire de ce Courrier *</h3>
                              <input  class="form-control" type="text" name="num_phone" value="<?php echo $v->num_phone; ?>">
                              <!------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer la date de reception de ce Courrier *</h3>
                              <input  class="form-control" type="date" name="date_expediteur" value="<?php echo $v->date_expediteur; ?>">
                              <!------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
...
<!-- ------------------------------------------------------------------ -->
              <div class="reply-form">
                <h4>Rechercher un Courrier Entran</h4>
