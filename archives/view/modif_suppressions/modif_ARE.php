...
<?php foreach ($arr as $k => $v): ?>
              ...
              <div class="reply-form">
                <form  method="post" action="<?php echo Router::url('modif_suppressions/modif_ARE/'); ?>">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                             <input hidden type="number" name="id" value="<?php echo $v->id; ?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer le Numéro de cet Arrêté</h3>
                              <input  class="form-control" type="text" name="num_arret" value="<?php echo $v->num_arret; ?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
<!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer l'Objet de cet Arrêté</h3>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer le nom du Signateur de cet Arrêté</h3>
...
<!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <input  class="form-control" type="text" name="date_signat" value="<?php echo $v->date_signat; ?>">
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                <input  class="btn btn-primary" type="submit" value="Modifier l'Arrêté &rarr; ">
                </form>
