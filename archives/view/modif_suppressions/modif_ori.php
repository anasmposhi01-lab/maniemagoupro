...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <!-- ------------------------------------------------------------------ -->
<?php foreach ($modifie_ori as $k => $v): ?>
              <center><h4>Veuillez apporter vos modifications dans le formulaire ci-dessous 👇</h4></center> 
              <div class="reply-form">
                <form  method="post" action="<?php echo Router::url('modif_suppressions/modif_ori/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                              ...
                              <select name="exploitant" type="text" class="anas1">
                                       <option value="<?php  echo $v->Exploitant; ?>"><strong><i>(Valeur actuelle):👉<?php  echo $v->Exploitant; ?></i></strong></option>
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!------------------------------------------------------------->
                            <h3>✍ Veuiller entrer le numéro de téléphone de la personne qui a reçu notre courrier</h3>
                            <input  class="form-control" type="number" name="num_phone_destina" value="<?php echo $v->num_phone_destina; ?>">
                           <!------------------------------------------------------------------>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                          <!--------------------------------------------------------------------->
                            <h3>✍ Veuiller entrer l'Objet de ce Courrier *</h3>
                              <textarea  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;" class="form-control" type="text" name="objet"><?php echo $v->objet; ?></textarea>
                           <!---------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                           ...
                           <input  class="form-control" type="date" name="date_rient" value="<?php echo $v->date_rient; ?>">
                              <!----------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!--------------------------------------------------------------->
                           <h3>✍ Veuiller entrer les orientations du Gouverneur attribuées à ce Courrier</h3>
                           <input  class="form-control" type="text" name="gouv_orient" value="<?php echo $v->gouv_orient; ?>">
                           <!----------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
