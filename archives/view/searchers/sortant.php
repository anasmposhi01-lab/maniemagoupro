<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
                                        <li><a href=""><?php  echo $total_sortants;?></a></li>
                                        <li>Courriers Sortants dont le dernier Numéro est N°: 
                                              <span><b style="color:blue;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('courriers_sortants/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
                                       </li>
        </ol>
        <h2>Repertoire d'un ou des courriers Sortants recherché(s)</h2>
...
<!-- ------------------------------------------------------------------ -->
              <div class="reply-form">
                <h4>Rechercher Un Courrier Sortant</h4>
