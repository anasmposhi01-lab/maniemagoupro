<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href=""><?php  echo $total_accuses;?></a></li>
                                       <li><a href=""><?php  echo $total_accuses;?></a></li>
                                       <li>Accusés Receptions dont le dernier Numéro est N°: 
                                              <span><b style="color:blue;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('accuses_reception/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
                                       </li>
        </ol>
        <h2>Repertoire d'un ou des Accusés Receptions recherché(s)</h2>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
              ...
              <!-- -----------------------------------------id, num_c, objet, nom_sign, date_reception, num_phone_destina, destinateur, type, file------------------------- -->
