<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href=""><?php  echo $total_arret;?></a></li>
                                      <li>Arrêtés signés dont le dernier Numéro est N°: 
                                              <span><b style="color:blue;"><?php echo $end_file->num_arret; ?></b></span><a href="<?php echo Router::webroot('les_arrêtes/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
                                       </li>
        </ol>
        <h2>Repertoire d'un ou des Arrêtés recherché(s)</h2>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
              ...
              <!-- ----------------------------------id, num_arret, objet, nom_sign, date_signat, type, file-------------------------------- -->
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  ...
                  <div>
                    <h5><a href="">N°<?php echo $v->num_arret; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> signé par: <?php  echo $v->nom_sign; ?> </a></h5><time datetime="2020-01-01">Date de Signature de l'Arrêté :<?php echo  ' '.$v->date_signat; ?></time>
