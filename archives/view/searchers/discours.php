<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
                                       <a href=""><?php  echo $total_discours;?></a>
                                       <li>discours prononcés dont le dernier est du    
                                              <span><?php echo $end_file->date; ?></span>, dont le Titre a été: <b><?php echo $end_file->date; ?></b> <a href="<?php echo Router::webroot('discours/'.$end_file->file); ?>"> <span><b style="color:red;">Télécharger &rarr; </b></span></a>
                                       </li>
        </ol>
        <h2>Repertoire d'un ou de Discours recherché(s)</h2>
              ...
              <div id="comment-1" class="comment">        
                     <div class="read-more">
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration de ce courrier<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous  vraiment modifier ce Courrier?');" href="<?php echo Router::url('modif_suppressions/modif_disc/'.$v->id);?>">
                                                 🛠 Modifier ce Courrier
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer ce courrier?');" href="<?php echo Router::url('modif_suppressions/suppr_disc/'.$v->id);?>">
