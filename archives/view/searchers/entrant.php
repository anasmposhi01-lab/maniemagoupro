<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
                                       <li><a href=""><?php  echo $total_entrants;?></a></li>
                                       <li>Courriers entrants dont le dernier Numéro est N°: 
                                              <span><b style="color:blue;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('courriers_entrants/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
                                       </li>
        </ol>
        <h2>Repertoire d'un ou des courriers entrants recherché(s)</h2>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><a href="<?php  echo Router::webroot('courriers_entrants/'.$v->file); ?>"><img src="<?php  echo Router::url('webroot/pdf.png');?>" alt=""></a></div>
                  <div>
                    <h5><a href="">N°<?php echo $v->num_c; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> signé par: <?php  echo $v->nom_sign; ?> </a></h5><time datetime="2020-01-01">Date reception du courrier le :<?php echo  ' '.$v->date_expediteur; ?></time>
                    
                    <b class="bi bi-reply-fill">Objet : </b><i><?php echo $v->objet; ?></i> 
                    <time datetime="2020-01-01" ><i style="color: red;"> Expéditeur Pricipal : </i><i> <?php  echo $v->expediteur; ?></i></time>
              ...
              <div class="entry-content">        
                ...
                <?php  endforeach; ?>
              <!-- ---------------------------id,num_c, objet, nom_sign, date_expediteur, num_phone, expediteur, type, file--------------------------------------- -->
