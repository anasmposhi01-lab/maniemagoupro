    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE DES COURRIERS SORTANTS DU GOUVERNEMENT PROVINCIAL DU MANIEMA SOUS LA GOUVERNANCE DE SON EXCELLENCE MUSSA KABWANKUBI MOÏSE</h2>
            <center>
          ...
          <a href="" style="color:red;"><?php  echo $total_sortants;?>/</a>Courriers Sortants dont le dernier Numéro est N°: 
          <span><b style="color:red;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('courriers_sortants/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
                 <?php  foreach ($sortants as $k=>$v): ?>
              <!-- ------------------------------------------id, num_c, objet, nom_sign, date_sign, num_phone, destinateur, type, file`------------------------ -->
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><a href="<?php echo Router::webroot('courriers_sortants/'.$v->file); ?>"><img src="<?php  echo Router::url('webroot/pdf.png');?>" alt=""></a></div>
                  <div>
                    <h5><a href="">N°<?php echo $v->num_c; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> signé par: <?php  echo $v->nom_sign; ?> </a></h5><time datetime="2020-01-01">Date de signature du courrier le :<?php echo  ' '.$v->date_sign; ?></time>
                    
                    <b class="bi bi-reply-fill">Objet : </b><p   style="text-align: justify;"><?php echo $v->objet; ?></p> 
                    <time datetime="2020-01-01" ><i style="color: red;"> Courrier envoyé à : </i><i> <?php  echo $v->destinateur; ?></i></time>
                    <time datetime="2020-01-01" ><i style="color: red;"> Date d'enrégistrement de ce Courrier :</i><i> <?php  echo $v->date_enre; ?></i></time>
                    <time datetime="2020-01-01" ><i style="color: red;"> Heure d'enrégistrement de ce Courrier :</i><i> <?php  echo $v->heure_enre; ?></i></time>
                  </div>
                </div>
              </div>
              <div id="comment-1" class="comment">        
                     <div class="read-more">
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration du courrier Sortant<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous  vraiment modifier ce Courrier Sortant?');" href="<?php echo Router::url('modif_suppressions/modif_sort/'.$v->id);?>">
                                                 🛠 Modifier ce Courrier
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer ce Courrier Sortant?');" href="<?php echo Router::url('modif_suppressions/suppression_sort/'.$v->id);?>">
...
<!--------------------------------------------------------------------------------------------------------------------------------------------->
              ...
              <div class="entry-content">        
                     <div class="read-more">
                         <a href="<?php echo Router::webroot('courriers_sortants/'.$v->file); ?>">Télécharger &rarr; </a>
                     </div>
              </div>
                <?php  endforeach; ?>
              <!-- ------------------------------------------------------------------ -->
