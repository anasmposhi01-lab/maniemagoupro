    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE D'ACCUSES RECEPTION/SORTANTS DU GOUVERNEMENT PROVINCIAL DU MANIEMA SOUS LA GOUVERNANCE DE SON EXCELLENCE MUSSA KABWANKUBI MOÏSE</h2>
            <center>
            ...
            <?php  echo $total_accuses;?>/Accusés Receptions dont le dernier Numéro est N°: 
            <span><b style="color:red;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('accuses_reception/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
            </i>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
                 <?php  foreach ($accuses as $k=>$v): ?>
              <!-- ----------------------------------------------------------------- -->
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><a href="<?php echo Router::webroot('accuses_reception/'.$v->file); ?>"><img src="<?php  echo Router::url('webroot/pdf.png');?>" alt=""></a></div>
                  <div>
                    <h5><a href="">N°<?php echo $v->num_c; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> destiné à: <?php  echo $v->nom_sign; ?> </a></h5><time datetime="2020-01-01">Date reception du courrier le :<?php echo  ' '.$v->date_reception; ?></time>
                    
                    <b class="bi bi-reply-fill">Objet : </b><p   style="text-align: justify;"><?php echo $v->objet; ?></p> 
                    <i class="bi bi-reply-fill" >Contact du destinateur :</i> 📞<?php  echo $v->num_phone_destina; ?> <br>
                    <i class="bi bi-reply-fill" >Date d'enrégistrement de cet Accusé :</i> 📞<?php  echo $v->date_enre; ?> <br>
                    <i class="bi bi-reply-fill" >Heure d'enrégistrement de cet Accusé :</i> 📞<?php  echo $v->heure_enre; ?> <br>
                  </div>
                </div>
              </div>
              <div id="comment-1" class="comment">        
                     <div class="read-more">
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration d'un Accusé<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment modifier cet Accusé de Réception?');" href="<?php echo Router::url('modif_suppressions/modif_AR/'.$v->id);?>">
                                                 🛠 Modifier ce Courrier
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer cet Accusé de Réception?');" href="<?php echo Router::url('modif_suppressions/suppression_AR/'.$v->id);?>">
...
<!--------------------------------------------------------------------------------------------------------------------------------------------->
              ...
              <div class="entry-content">        
                     <div class="read-more">
                         <a href="<?php echo Router::webroot('accuses_reception/'.$v->file); ?>">Télécharger &rarr; </a>
                     </div>
              </div>
                <?php  endforeach; ?>
              <!-- ------------------------------------------------------------------ -->
