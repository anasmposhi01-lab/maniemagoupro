    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE DES ARRETES DU GOUVERNEMENT PROVINCIAL DU MANIEMA SOUS LA GOUVERNANCE DE SON EXCELLENCE MUSSA KABWANKUBI MOÏSE</h2>
            <center>
            ...
            <?php  echo $total_arret;?>/Arrêtés signés dont le dernier Numéro est N°: 
            <span><b style="color:red;"><?php echo $end_file->num_arret; ?></b></span><a href="<?php echo Router::webroot('les_arrêtes/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
            </i>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
                 <?php  foreach ($arret as $k=>$v): ?>
              <!-- ------------------------------------------------------------- -->
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><a href="<?php echo Router::webroot('les_arrêtes/'.$v->file); ?>"><img src="<?php  echo Router::url('webroot/pdf.png');?>" alt=""></a></div>
                  <div>
                    <h5><a href="">Arrêté N°<?php echo $v->num_arret; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> signé par: <?php  echo $v->nom_sign; ?> </a></h5><time datetime="2020-01-01">Du :<?php echo  ' '.$v->date_signat; ?></time>
                    
                    <b class="bi bi-reply-fill">Portant : </b><p   style="text-align: justify;font-family:Helvetica,Arial,sans-serif;text-transform: uppercase;"><?php echo $v->objet; ?></p> 
                    <time datetime="2020-01-01">Date d'enrégistrement de cet Arrêté :<?php echo  ' '.$v->date_enre; ?></time>
                    <time datetime="2020-01-01">Heure d'enrégistrement de cet Arrêté :<?php echo  ' '.$v->heure_enre; ?></time> 
                  </div>
                </div>
              </div>
              <div id="comment-1" class="comment">        
                     <div class="read-more">
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration de l'Arrêté<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous  vraiment modifier cet Arrêté?');" href="<?php echo Router::url('modif_suppressions/modif_ARE/'.$v->id);?>">
                                                 🛠 Modifier l'Arrêté
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer  cet Arrêté?');" href="<?php echo Router::url('modif_suppressions/suppression_ARE/'.$v->id);?>">
                                               🗑 Supprimer l'Arrêté
                                               </a>
                                            </li>
                            <!-------------------------------------------------------->
...
<!--------------------------------------------------------------------------------------------------------------------------------------------->
              ...
              <div class="entry-content">        
                     <div class="read-more" >
                         <a href="<?php echo Router::webroot('les_arrêtes/'.$v->file); ?>">Télécharger &rarr; </a>
                     </div>
              </div>
                <?php  endforeach; ?>
              <!-- ------------------------------------------------------------------ -->
