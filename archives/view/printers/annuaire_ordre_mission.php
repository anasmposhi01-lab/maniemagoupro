    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE DES ORDRES DE MISSION</h2>
            <center>
        ...
        / Dernier Numéro de l'Ordre de Mission signé est:<span><b style="color:black;"><?php echo  ' '.$end_file->num; ?></b></span><a href="<?php echo Router::webroot('ordres_missions/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
      </div>
            ...
            <div class="blog-comments">                 
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  ...
                  <i><u>Destination</u> : <time datetime="2020-01-01" style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;"><?php echo  $v->destination; ?></time></i>
                    ...
                    <time datetime="2020-01-01" ><i style="color: red;"> Nom du Titulaire Pricipal Principal : </i><i  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;"> <?php  echo $v->nom_titulaire_mission; ?></i></time>
                    <time datetime="2020-01-01" ><i style="color: red;"> Fonction du Titulaire Pricipal Principal : </i><i  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;"> <?php  echo $v->fonction_titulaire_mission; ?></i></time>
