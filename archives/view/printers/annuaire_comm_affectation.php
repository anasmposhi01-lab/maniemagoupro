    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE DES COMMISSIONS D'AFFECTATION DU GOUVERNEMENT PROVINCIAL DU MANIEMA SOUS LA GOUVERNANCE DE SON EXCELLENCE MUSSA KABWANKUBI MOÏSE</h2>
            <center>
            ...
            <?php  echo $total_comm_affect;?>/Commissions d'Affectation dont le dernier Numéro est N°: 
            <span><b style="color:red;"><?php echo $end_file->num; ?></b></span><a href="<?php echo Router::webroot('commission_d_affectation/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
            </i>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">                 
                 <?php  foreach ($comm_affect as $k=>$v): ?>
              <!-- ----------------------------------------------------------------- -->
                            ...
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration de la Commission<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous  vraiment modifier cette Commission?');" href="<?php echo Router::url('modif_suppressions/modif_comm_affect/'.$v->id);?>">
                                                 🛠 Modifier cette Commission
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer cette Commission?');" href="<?php echo Router::url('modif_suppressions/suppr_comission/'.$v->id);?>">
