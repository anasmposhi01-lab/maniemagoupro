    ...
    <section id="services" class="services section-bg ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REPERTOIRE DES COURRIERS ORIENTES DU GOUVERNEMENT PROVINCIAL DU MANIEMA SOUS LA GOUVERNANCE DE SON EXCELLENCE MUSSA KABWANKUBI MOÏSE</h2>
            <center>
            ...
            <?php  echo $total_orientes;?>/Courriers entrants Orientés dont le dernier Numéro est N°: 
            <span><b style="color:red;"><?php echo $end_file->num_c; ?></b></span><a href="<?php echo Router::webroot('courriers_orientes/'.$end_file->file); ?>"> <span>👉<b style="color:red;">Télécharger &rarr; </b></span></a>
      </div>
            ...
            <div class="blog-comments">                 
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  ...
                  <div>
                    <h5><a href="">N°<?php echo $v->num_c; ?></a> <a href="#" class="reply"><i class="bi bi-reply-fill"></i> Orienté à: <?php  echo $v->Exploitant; ?> pour exploitation.</a></h5><time>Date d'orientation :<?php echo  ' '.$v->date_rient; ?> enrégistré le :<?php echo  ' '.$v->date_enre; ?> à : <?php echo  '  '.$v->heure_enre; ?>.</time>
                    <time datetime="2020-01-01"><b>Instruction de l'Autorité  :</b> <?php echo  ' '.$v->gouv_orient; ?></time>
              ...
              <div id="comment-1" class="comment">        
                     <div class="read-more">
                            <nav id="navbar" class="navbar order-last order-lg-0">
                                 <ul>
                                      <li class="dropdown"><a href="#"> ⚙ Configuration du Courrier Orienté<i class="bi bi-chevron-down"></i></a>
                                         <ul>
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment modifier ce Courrier Orienté?');" href="<?php echo Router::url('modif_suppressions/modif_ori/'.$v->id);?>">
                                                 🛠 Modifier ce Courrier
                                               </a>
                                            </li>
                               <!-------------------------------------------------------->
                                            <li>          
                                               <a onclick="return confirm('Voulez-vous vraiment supprimer ce courrier Orienté?');" href="<?php echo Router::url('modif_suppressions/suppression_ori/'.$v->id);?>">
