<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE D'ENREGISTREMENT DES COURRIERS ENTRANTS DU GOUVERNORAT</h2>
        <u style="color: red;"><center>*******************************************************************</center></u>
        <ol>
          <li><a href="" style="color: red;"><?php echo $this->Session->flash(); ?></a></li>
          <li style="text-align: justify;">Cette page vous permet d'enrégistrer des Courriers Entrants que le Service en charges de courriers Entrants, ont enrégistré lors de la reception desdits courriers.  Egalement, cette page permet de faire des recherches, en cas de besoin, dans notre serveur pour une utilisation utile. dans la partie annexe de cette page, vous êtes informé de toutes les statistiques liées au nombres de nos différents courriers, selon leur catégorie y compris les Arrêtés qui ont été signés par le Gouvernement Provincial du Maniema. Un bonus lié à l'accès aux listes reparties selon les différentes réunions tenues au Cabinet du Gouverneur s'y trouvent également.
          </li>
        </ol>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/courriers_entrants/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <?php echo $this->Form->input('num_c','', array('class'=>'form-control','type'=>'text','placeholder'=>'✍ Veuiller entrer le Numéro accordé par nos Service à ce Courrier')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <?php echo $this->Form->input('nom_sign','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer le nom de le nom de la Personne Signataire de ce Courrier')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('expediteur','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer le Nom de l\'Expéditeur Principalement oule nom de la Société: c\'est facultatif')); ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                              <?php echo $this->Form->input('num_phone','', array('class'=>'form-control','type'=>'number','placeholder'=>' ✍ Veuiller entrer le Numéro de Téléphone du Propriétaire de ce Courrier ')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <?php echo $this->Form->input('date_expediteur','', array('class'=>'form-control','type'=>'date','placeholder'=>' ✍ Veuiller entrer la date de reception de ce Courrier')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
