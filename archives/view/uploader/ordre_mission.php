...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/ordre_mission/'); ?>" enctype="multipart/form-data">

                  <div>

                    <div  class="tiny-editable">
                           <textarea  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;" name="objet" type="text" class="form-control" placeholder=" ✍ Veuiller entrer l'Objet de cet Ordre de Mission *"></textarea>
                           <!---------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <?php echo $this->Form->input('num','', array('class'=>'form-control','type'=>'text','placeholder'=>'✍ Veuiller entrer le Numéro de cet Ordre de Mission *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <?php echo $this->Form->input('destination','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer la Destination pour cet Ordre de Mission *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('nom_titulaire_mission','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer le Nom du Titulaire pour cet Ordre de Mission *')); ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                              <?php echo $this->Form->input('fonction_titulaire_mission','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer la Fonction du Titulaire pour cet Ordre de Mission * ')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3  >✍ Veuiller entrer la date de signature de cet Ordre de Mission</h3>
                              <?php echo $this->Form->input('date_signature','', array('class'=>'form-control','type'=>'date','placeholder'=>'  ✍ Veuiller entrer la Date de signature de cet Ordre de Mission *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
