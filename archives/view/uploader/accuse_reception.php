<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE D'ENREGISTREMENT DES ACCUSES DE RECEPTIONS DES COURRIERS DU GOUVERNEMENT PROVINCIAL DU MANIEMA</h2>
        <u style="color: red;"><center>*******************************************************************</center></u>
        <ol>
          <li><a href="" style="color: red;"><?php echo $this->Session->flash(); ?></a></li>
          <li style="text-align: justify;">Cette page vous permet d'enrégistrer des Accusés réception des Courriers Sortants que le Service en charges de courriers Sortants, ont déposés auprès des destnateurs desdits courriers, contenant sceaux et ou signature de reception.  Egalement, cette page permet de faire des recherches, en cas de besoin, dans notre serveur pour une utilisation utile. dans la partie annexe de cette page, vous êtes informé de toutes les statistiques liées au nombres de nos différents courriers, selon leur catégorie y compris les Arrêtés qui ont été signés par le Gouvernement Provincial du Maniema. Un bonus lié à l'accès aux listes reparties selon les différentes réunions tenues au Cabinet du Gouverneur s'y trouvent également.
          </li>
        </ol>
      </div>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/accuse_reception/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                             <?php echo $this->Form->input('num_c','', array('class'=>'form-control','type'=>'text','placeholder'=>'✍ Veuiller entrer le Numéro de ce Courrier remis')); ?>
...
<!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                           <textarea style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;"  name="objet" type="text" class="form-control" placeholder=" ✍ Veuiller entrer l'Objet de ce Courrier *"></textarea>
                           <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                             ...
                             <?php echo $this->Form->input('date_reception','', array('class'=>'form-control','type'=>'date','placeholder'=>' ✍ Veuiller entrer la date de reception de ce Courrier')); ?>
<!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                             <?php echo $this->Form->input('destinateur','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuiller entrer le nom de la personne à qui notre courrier s\'adresse ')); ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
...
<!-- ------------------------------------------------------------------ -->
              <div class="reply-form">
                <h4>Rechercher un Accusé de Recherche</h4>
                <p>Veuillez 👇 selectioner le mode de recherche * </p>
                <form   method="post" action="<?php echo Router::url('searchers/accuse_reception/'); ?>" enctype="multipart/form-data" >
                  <div class="row">
                    <div class="col-md-6 form-group">
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item search-form">
                <form   method="post" action="<?php echo Router::url('searchers/accuse_reception/'.$id=1); ?>" enctype="multipart/form-data" >
