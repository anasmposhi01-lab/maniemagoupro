<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE QUI VOUS PERMET DE SOUMETTRE VOTRE RESUME ET DECISIONS PRISES A LA REUNION</h2>
            ...
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <?php foreach ($reunions as $k=>$v): ?>
                  <form  method="post" action="<?php echo Router::url('uploader/reunion_discussions/'); ?>" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col form-group">
                                <!----------------------------------------------------------------------------------------------------------------->
                                <h3>✍ Résumé des points discutés lors de la Réunion</h3>
                                 <?php echo $this->Form->input('points_discutes','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!----------------------------------------------------------------------------------------------------------------->
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                                <!----------------------------------------------------------------------------------------------------------------->
                                <h3>✍ Faits importants et décisions prises</h3>
                                 <?php echo $this->Form->input('faits_decisions','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!----------------------------------------------------------------------------------------------------------------->
                      </div>
                    </div>                  
                  <div class="row">
