...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/comm_affectation/'); ?>" enctype="multipart/form-data">

                  <div>
                    <div  class="tiny-editable">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <?php echo $this->Form->input('num','', array('class'=>'form-control','type'=>'text','placeholder'=>'✍ Veuillez entrer le Numéro de cette Commission/Chams Obligatoire à remplir *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                              <?php echo $this->Form->input('division','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuillez entrer le nom de la Division pour cette Commussion/Chams Obligatoire à remplir *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <?php echo $this->Form->input('fonction','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuillez Entrer la Fonction de l\'Agent affecté/Chams Non Obligatoire à remplir s\'il s\'agit d\'une Commussion collective. *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                              <?php echo $this->Form->input('Nom_personne_affect','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuillez Entrer le Nom de l\'Agent affecté/Chams non Obligatoire à remplir: cas d\'une Commussion Collective. *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3></h3>
                              <?php echo $this->Form->input('lieu_affectation','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Veuillez entrer le lieux d\'Affectation de l\'Agent(Facultatif s\'il s\'agit d\'une Commission Collective *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Selectionez la date de signature *</h3>
                              <?php echo $this->Form->input('date_signature','', array('class'=>'form-control','type'=>'date','placeholder'=>' ✍ Veuiller Entrer la date de signature de cette Commission *')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                              <!----------------------------------------------------------------------------------------------------------------->
                  ...
                  <div class="row">
                    <div class="col form-group">
                              ...
                              <!----------------------------------------------------------------------------------------------------------------->
                              <li> Cliquez 👇 ci-dessous pour Importer votre Commission *</li>
