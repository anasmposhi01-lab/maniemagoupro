<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE D'ENREGISTREMENT DES MEMBRES AYANT PARTICIPES A LA REUNION DU GOUVERNEMENT PROVINCIAL DU MANIEMA</h2>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                <h4>Veuillez remplir ce formulaire avec les les informations du Participant</h4>
                <?php  foreach ($reunion as $k=>$v): ?>
                <form  method="post" action="<?php echo Router::url('uploader/reunion_ajout_part/'); ?>" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6 form-group">
                              ...
                              </select>👆🏻 Veuillez selectioner le Sexe du Participant *.
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                               <?php echo $this->Form->input('nom','', array('class'=>'form-control','type'=>'text','placeholder'=>'🙎🏻‍ nom Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('post_nom','', array('class'=>'form-control','type'=>'text','placeholder'=>' 🙎🏻‍ Post-nom Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('prenom','', array('class'=>'form-control','type'=>'text','placeholder'=>' 🙎🏻‍ Prénom Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('fonction','', array('class'=>'form-control','type'=>'text','placeholder'=>' 🦺 Fonction Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('num_phone','', array('class'=>'form-control','type'=>'number','placeholder'=>' ☎ Phone Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                               <?php echo $this->Form->input('e_mail','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ E_Mail Participant *')); ?>
                             <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
...
<!-- ------------------------------------------------------------------ -->
              <div class="reply-form">
                <h4>S'informer sur une de Réunions</h4>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                              <select name="mode" type="text"  class="anas1">
                                       <option value="nom"><strong><i>Nom du Participant *</i></strong></option>
                                       <option value="objet"><strong><i>Objet de la Réunion *</i></strong></option>
                                       <option value="post_nom"><strong><i>Post-nom du participant *</i></strong></option>
                                       <option value="prenom"><strong><i>Prénom du participant *</i></strong></option>
                                       <option value="fonction"><strong><i>Fonction du participant *</i></strong></option>
                              </select>
                    </div>
                  </div>
                  <div class="row">
