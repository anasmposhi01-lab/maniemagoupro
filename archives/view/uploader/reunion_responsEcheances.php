...
<?php foreach ($reunions as $k=>$v): ?>
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/reunion_responsEcheances/'); ?>" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col form-group">
                                <!-------------responsabilites`, `echeances---------------------------------------------------------------------------------------------------->
                                <h3>✍ Lister les responsabilites reparties</h3>
                                 <?php echo $this->Form->input('responsabilites','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!----------------------------------------------------------------------------------------------------------------->
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                                <!----------------------------------------------------------------------------------------------------------------->
                                <h3>✍ echeances reparties</h3>
                                 <?php echo $this->Form->input('echeances','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
