<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2 style="text-align: center;">BIENVENUE SUR LA PAGE D'ENREGISTREMENT DES DISCOURS PRONONCES PAR SON EXCELLENCE MONSIEUR LE GOUVERNEUR/MANIEMA</h2>
...
<!-- ------------------------------------------------------------------ -->
            <div class="blog-comments">
              ...
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/discours/'); ?>" enctype="multipart/form-data">

                  <div class="row">
                    <div class="col form-group">
                              <textarea  style="font-family:Helvetica,Arial,sans-serif; text-transform: uppercase;" name="titre" class="form-control" type="text" placeholder=" ✍ Veuiller entrer le Titre de ce Discours *"></textarea>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <?php echo $this->Form->input('orateur','', array('class'=>'form-control','type'=>'text','placeholder'=>' ✍ Le Discours a été tenu par qui? Entrez sa Fonction svp.')); ?>
                              <!----------------------------------------------------------------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <h3>✍ Veuiller entrer la date que ce Discours a été tenu</h3>
                              <?php echo $this->Form->input('date','', array('class'=>'form-control','type'=>'date','placeholder'=>' ✍ Veuiller entrer la date que ce Discours a été tenu')); ?>
                              <!------------------------------------------------------->
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                              <!----------------------------------------------------------------------------------------------------------------->
                              <li> Cliquez 👇 ci-dessous pour Importer le fichier de ce Discours</li>
                              <?php echo $this->Form->input('file','',array('class'=>'form-control', 'hidden','type' =>'file')); ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                              <select name="mode" type="text"  class="anas1">
                                       <option value="titre"><strong><i>Titre du Discours *</i></strong></option>
