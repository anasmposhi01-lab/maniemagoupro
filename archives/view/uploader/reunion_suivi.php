...
<?php foreach ($reunions as $k=>$v): ?>
              <div class="reply-form">
                ...
                <form  method="post" action="<?php echo Router::url('uploader/reunion_suivi/'); ?>" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col form-group">
                                <!---------------------------------------------->
                                <h3>✍ Lister les Prochaines Etapes prévues pour cette cette Réunion</h3>
                                 <?php echo $this->Form->input('Prochaines_Etapes','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!--------------------------------------------------->
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                                <!------------------------------------------>
                                <h3>✍ Lister ce qui a été prévu pour l'organistion des prochaines Réunions de suivi</h3>
                                 <?php echo $this->Form->input('prochaines_reunions','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!------------------------------------------------>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                                <!------------------------------------------->
                                <h3>✍ Lister les Personnes en Charge de suivi des Décisions prises lors de cette Réunion</h3>
                                 <?php echo $this->Form->input('Personnes_Charge_suivi','', array('type'=>'textarea',  'id'=>'editor','class'=>'xxlarge wysiwyg','rows'=>10, 'cols'=>200)); ?>
                               <!---------------------------------------------------->
                      </div>
                    </div>
                    <div class="row">
